package me.leefeng.beida.newplay;
...
public class NewPlayerActivity extends BaseActivity implements View.OnClickListener {
    ...
    private File file;
    private View newplayer_list;
    private RelativeLayout newplayer_adbanner;
    ...
    protected void initData() {
        ...
        newplayer_adbanner.addView(banner);
        /* 发起广告请求，收到广告数据后会展示数据   */
        banner.loadAD();
    }
    ...
    protected void initView() {
        ...
        newplayer_list.setLayoutParams(recycleParams);
...
//            SwipeBackHelper.getCurrentPage(this).setSwipeBackEnable(true);
            fab.setVisibility(View.GONE);
            newplayer_list.setVisibility(View.VISIBLE);
        } else {
//            SwipeBackHelper.getCurrentPage(this).setSwipeBackEnable(false);
            fab.setVisibility(View.GONE);
            newplayer_list.setVisibility(View.GONE);
        }
    }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.fab:
                ...
                setAnimY(newplayer_list, player.getMeasuredHeight(), titleHeight);
                padingY(newplayer_list, 0, down_bottom_height);
            ...
            case R.id.title_back:
                setAnimY(newplayer_list, titleHeight, player.getMeasuredHeight());
                padingY(newplayer_list, down_bottom_height, 0);
